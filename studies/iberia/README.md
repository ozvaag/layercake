...
- **Ground (field):** NASA POWER daily API v2 (MERRA-2 / GEOS), parameters PRECTOTCORR, T2M_MAX, T2M_MIN, T2M, community AG — public domain (NASA); fetched 2026-09-18; 242 grid points at 0.5°; Oct–Sep, named by the year it ends; ET₀ Hargreaves–Samani (FAO-56 eq. 52) from MERRA-2 Tmax/Tmin/Tmean; normals 1991–2020.
...
- **Indicators (series):** World Bank Indicators API v2 — CC BY 4.0; fetched 2026-09-18; 16 series.
...
> *Iberia* — a Layercake study, built 2026-09-18. https://layercake.pages.dev/study?s=iberia · https://github.com/ozvaag/layercake/tree/main/studies/iberia
