...
frame_from: "<study id>"           reuse another study's frame (geo/, basins, relief) for a second question on the same place
derive: [{ id, num, den | "<series>.area", scale, label, unit }]   a marks series divided by another, per place per year
